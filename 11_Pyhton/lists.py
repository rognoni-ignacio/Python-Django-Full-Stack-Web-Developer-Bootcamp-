...
print("List of different object type")
...
print("Grab first element")
print(my_list[0])

# Grab index 1 and everything past it
print("Grab from index 1")
print(my_list[1:])

# Grab everything UP TO index 3
print("Grab everything UP TO index 3")
print(my_list[:3])

# We can also use + to concatenate lists, just like we did for strings.
print("Concatenate listis")
print(my_list + ['new item'])


# Note: This doesn't actually change the original list!
print("This doesn't change the original list")
print(my_list)
...
print("Reverse list (It's permanent)")
new_list.reverse()
...
# Show
print("Matrix (List inside a List)")
print(matrix)
...
print("First element of the first item in the matrix")
print(matrix[0][0])
